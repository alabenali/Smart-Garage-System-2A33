...
### 3. Accès
- **Frontoffice**: http://localhost/projet_final/controllers/UserController.php?action=showLogin
- **Backoffice**: http://localhost/projet_final/controllers/AdminController.php?action=showLogin
