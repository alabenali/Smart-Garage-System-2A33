...
// 4. URI de redirection autorisée : http://localhost/integration/client/controllers/UserController.php?action=googleCallback
// 5. Copiez les deux valeurs ci-dessous
define('GOOGLE_CLIENT_ID',     getenv('GOOGLE_CLIENT_ID') ?: '');
define('GOOGLE_CLIENT_SECRET', getenv('GOOGLE_CLIENT_SECRET') ?: '');
define('GOOGLE_REDIRECT_URI',  getenv('GOOGLE_REDIRECT_URI') ?: 'http://localhost/integration/client/controllers/UserController.php?action=googleCallback');
