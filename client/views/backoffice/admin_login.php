...
<div class="login-card">
    ...
    <form id="adminLoginForm" method="POST" action="/integration/client/controllers/AdminController.php?action=login" novalidate>
    ...
    <div class="back-link"><a href="/integration/client/views/frontoffice/login.php"><i class="fas fa-arrow-left"></i> Retour à l'espace client</a></div>
</div>
