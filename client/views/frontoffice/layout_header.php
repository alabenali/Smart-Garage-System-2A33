...
<div class="app-shell">
    <aside class="app-sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="/integration/diagnostic/frontoffice.php?action=mes_diagnostics" class="<?php echo in_array($action, ['clientDiagnostics', 'clientDiagnosticDashboard', 'mes_diagnostics'], true) ? 'active' : ''; ?>"><i class="bi bi-clipboard2-pulse"></i> Mes diagnostics</a>
            <a href="/integration/diagnostic/frontoffice.php?action=client_interventions" class="<?php echo $action === 'clientInterventions' ? 'active' : ''; ?>"><i class="bi bi-tools"></i> Mes interventions</a>
            <a href="/integration/diagnostic/frontoffice.php?action=client_messages" class="<?php echo $action === 'clientDiagnosticMessages' ? 'active' : ''; ?>"><i class="bi bi-chat-left-text"></i> Suivi messages</a>
