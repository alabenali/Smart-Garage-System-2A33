...
<head>
    ...
    <style>
        .strength-bar { height:4px; border-radius:2px; margin-top:6px; background:#E2E8F0; transition:all .3s; }
...
<div class="auth-card">
    ...
    <form id="resetForm" method="POST" action="/integration/client/controllers/UserController.php?action=resetPassword" novalidate>
