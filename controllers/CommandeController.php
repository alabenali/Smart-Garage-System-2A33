    ...
    private function createCommande(array $data)
    {
        try {
            ...
            $insertStmt = $this->conn->prepare(
                'INSERT INTO commandes (id_piece, nom_client, prenom_client, telephone, quantite, montant_total, statut, payment_method, payment_status, payment_gateway_reference)
                 VALUES (:id_piece, :nom_client, :prenom_client, :telephone, :quantite, :montant_total, :statut, :payment_method, :payment_status, :payment_gateway_reference)'
            );
            $insertStmt->execute([
                ':id_piece' => (int) $data['id_piece'],
                ':nom_client' => $data['nom_client'],
