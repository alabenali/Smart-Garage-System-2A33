...
<div class="app-shell">
    <aside class="app-sidebar">
        ...
        <nav class="sidebar-nav">
            <a href="/integration/vehicule%20et%20rdv/index.php?action=dashboard"><i class="bi bi-speedometer2"></i> Dashboard</a>
                ...
                <?php if ($result !== null): ?>
                    <div class="result-box <?php echo $result['success'] ? 'result-success' : 'result-fail'; ?>">
                        ...
                        <?php foreach ($result['logs'] as $log): ?>
                            <div class="step-item">
                                <?php
                                $isOk = strpos($log, 'FAIL') === false
                                    && strpos($log, 'FALLBACK') === false
                                    && stripos($log, 'Erreur') === false;
                                ?>
