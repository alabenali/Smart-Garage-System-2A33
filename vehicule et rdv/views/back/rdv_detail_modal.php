            ...
            <div class="rdv-card" data-rdv-id="<?php echo (int) $rdv['id_rdv']; ?>">
                <div class="rdv-main">
                    <strong>
                        ...
                        echo htmlspecialchars($clientName !== '' ? $clientName : (!empty($rdv['id_client']) ? 'Client #' . (int) $rdv['id_client'] : 'Client non rattache'));
                        ?>
                    </strong>
                    <span><?php echo htmlspecialchars(trim(($rdv['marque'] ?? '') . ' ' . ($rdv['modele'] ?? '') . ' ' . ($rdv['immatriculation'] ?? '')) ?: 'Vehicule non rattache'); ?></span>
                ...
                <div class="rdv-actions-inline">
                    <a href="index.php?action=backEditRdv&id=<?php echo (int) $rdv['id_rdv']; ?>" class="btn-sg btn-sg-outline btn-sg-sm">Modifier</a>
