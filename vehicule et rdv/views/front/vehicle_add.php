...
<div class="sg-form-wrap">
    <form method="POST" action="index.php?action=addVehicle<?php echo $next !== '' ? '&next=' . urlencode($next) : ''; ?>" id="vehicleForm" novalidate
        ...
        <div class="sg-form-grid">
            ...
            <div class="sg-form-actions">
                ...
                <a href="/integration/client/controllers/UserController.php?action=showDashboard" class="btn-sg btn-sg-outline">Mon espace</a>
                <a href="<?php echo $next === 'client' ? '/integration/client/controllers/UserController.php?action=showDashboard' : 'index.php?action=showVehicles'; ?>" class="btn-sg btn-sg-outline">Annuler</a>
            </div>
        </div>
    </form>
</div>
