                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ((int) $p['quantite_stock'] <= 0): ?>
                                    <span class="badge-stock out-of-stock"><?php echo (int) $p['quantite_stock']; ?> - Rupture</span>
                                <?php elseif ((int) $p['quantite_stock'] <= (int) $p['seuil_alerte']): ?>
                                    <span class="badge-stock low-stock"><?php echo (int) $p['quantite_stock']; ?> - Faible</span>
                                <?php else: ?>
