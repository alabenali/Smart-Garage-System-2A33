...
<?php else: ?>
    <div class="history-grid">
        <?php foreach ($commandes as $c): ?>
            ...
            ?>
            <article class="history-card history-card-shell" style="background:#ffffff;border:1px solid #d9dee5;border-radius:12px;padding:1.2rem;box-shadow:0 2px 12px rgba(0,0,0,0.08);">
