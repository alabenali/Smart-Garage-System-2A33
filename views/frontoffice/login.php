...
<head>
    ...
    <style>
        ...
        #btnVerify:hover:not(:disabled) { transform: translateY(-2px); box-shadow: 0 6px 20px rgba(0,229,255,0.35); }
...
<div class="auth-card">
    ...
    <a href="/projet_final/controllers/UserController.php?action=googleLogin"
...
async function loadProfileDescriptor(email) {
    const res  = await fetch('/projet_final/controllers/UserController.php?action=getFaceImage', {
        method: 'POST',
...
function submitPendingForm() {
    ...
    realForm.action = '/projet_final/controllers/UserController.php?action=login';
